...
\begin{figure}[htbp]
  \begin{center}
    \includegraphics[scale=0.24]{eps/uniformGIMP.eps}
  \end{center}
...
全体として実験値よりも圧力が大きいのは，壁面を滑りあり条件で解析したことが要因だと考える．
\begin{figure}
  \scalebox{0.4}{ % ← ここを変える
    \begin{minipage}{\linewidth}
      \hspace*{-1cm}
      \input{graph/s1_p1.tex}
      \hspace*{-1cm}
      \input{graph/s1_p3.tex}
      \hspace*{-1cm}
      \input{graph/s1_p6.tex}
    \end{minipage}
  }
  \caption{圧力推移(上:P1，中央:P3，下:P6圧力推移)}
  \label{fig:slip1}
\end{figure}
